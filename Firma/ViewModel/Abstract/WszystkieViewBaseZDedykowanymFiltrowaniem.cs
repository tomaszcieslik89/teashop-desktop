...
{
    public abstract class WszystkieViewBaseZDedykowanymFiltrowaniem<T> : WorkspaceViewModel
    {
        #region Fields
        ...
        public string CenaOd
        {
            ...
            set
            {
                ...
                {
                    _CenaOd = value;
                    OnPropertyChanged<string>(() => CenaOd);
                }
            }
        }
        private string _CenaDo;
        ...
        public string CenaDo
        {
            ...
            set
            {
                ...
                {
                    _CenaDo = value;
                    OnPropertyChanged<string>(() => CenaDo);
                }
            }
        }
        #endregion
        #region Constructor
        public WszystkieViewBaseZDedykowanymFiltrowaniem(String displayName)
        {
