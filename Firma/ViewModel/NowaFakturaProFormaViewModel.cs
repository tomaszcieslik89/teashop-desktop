...
{
    public class NowaFakturaProFormaViewModel : JedenViewModel<DokumentSprzedazy>
    {
        #region Constructor
        private List<int> towary;
        public NowaFakturaProFormaViewModel()
            : base("Faktura pro forma")
        {
        ...
        public override void Save()
        {
            ...
            foreach (var itemTowar in towary)
            {
                ...
                if (towar.Ilosc == 0)
                {
                    ...
                    MessageBox.Show("Niewystarczajaca ilość towaru na magazynie.");
                    break;
                }
            }
            if (czyWyjscZfunkcji)
            ...
            item.IdRodzajuDokumentow = 3;//zapisze jako Proforma
