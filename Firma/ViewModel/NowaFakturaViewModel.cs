...
{
    public class NowaFakturaViewModel : JedenViewModel<DokumentSprzedazy>/*Faktura*/
    {
        #region Konstruktor
        ...
        private string _MarkaTowaru;

        public string MarkaTowaru
        {
            get
            {
                return _MarkaTowaru;
            ...
            set
            {
                if (_MarkaTowaru != value)
                {
                    _MarkaTowaru = value;
                    base.OnPropertyChanged(() => MarkaTowaru);
                }
            }
        }
        ...
        public override void Save()
        {
            ...
            item.IdRodzajuDokumentow = 2;//zapisze jako FAKTURA
